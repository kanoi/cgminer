...
char *uart1_device_name = "/dev/ttyS1";
char *uart2_device_name = "/dev/ttyS2";
char *uart3_device_name = "/dev/ttyS3";

int8_t uart_init(device_t* attr, int8_t mode, uint32_t speed, uint16_t size)
{
